...
class Host_Interface extends Meta{
  ...
  public static $va_external=array("addr_obj"=>array("class"=>"Net_Address","table"=>"link_hosts_interfaces_net_addresses","own_key"=>"interface_id","external_key"=>"address_id"));
